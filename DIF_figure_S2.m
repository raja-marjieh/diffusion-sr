...
tcnt=tcnt+1;
QQ=QQ0;
QQ.NOISE_TYPE=NOISE_TYPE_GAUSSIAN;
...
QQ=QQ0;
QQ.NOISE_TYPE=NOISE_TYPE_GAUSSIAN;
QQ.IS_DENOISE_ONLY=true; % NOTE !!! IMPORTANT (skip adding noise in the synthesis step, compatability with a version of DDPM that do not include noise)
T=10;
sigma0=0.03;sigma1=0.1; sigma_vec=linspace(sigma0,sigma1,T);
todoS{tcnt,1}.QQ=QQ;
todoS{tcnt,1}.sigma_vec=sigma_vec;
...
% tcnt=tcnt+1;
% QQ=QQ0;
% QQ.NOISE_TYPE=NOISE_TYPE_STRECH;
% QQ.IS_DENOISE_ONLY=false;% NOTE !!! IMPORTANT (do not skip adding noise in the synthesis step, compatability with a version of DDPM that do not include noise)
% T=10;
